  ...
  return (
    <>
        ...
        <div className="container mx-auto px-6 flex justify-between items-center">
          <div className="flex items-center cursor-pointer" onClick={() => onNavigate('home')}>
            <div className="w-8 h-8 bg-gradient-almandine rounded-bl-xl rounded-tr-xl flex items-center justify-center transform rotate-45">
              <div className="transform -rotate-45 font-display font-black text-xs">A</div>
            </div>
          ...
          <button 
            ...
            className="bg-gradient-almandine px-6 py-2 rounded-full text-xs font-bold uppercase tracking-widest hover:scale-105 active:scale-95 transition-transform shadow-[0_0_20px_rgba(255,0,76,0.3)]"
          >
            Shop Now
          </button>
        </div>
      ...
      <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-40 overflow-hidden">
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[1000px] h-[1000px] bg-[#ff004c]/10 blur-[150px] rounded-full pointer-events-none"></div>
        <div className="container mx-auto px-6 flex flex-col lg:flex-row items-center justify-between relative z-10">
          <div className="w-full lg:w-1/2 text-center lg:text-left mb-16 lg:mb-0">
            <div className="inline-block px-4 py-1 rounded-full border border-red-900/50 bg-red-950/20 text-[#ff004c] text-xs font-bold uppercase tracking-widest mb-6">
            ...
            <h1 className="font-display text-5xl lg:text-8xl font-black leading-none tracking-tighter mb-8 uppercase italic">
              Unleash the <span className="text-gradient">Garnet</span> within
            </h1>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start space-y-4 sm:space-y-0 sm:space-x-4">
              <button 
                onClick={() => onNavigate('shop')}
                className="w-full sm:w-auto bg-white text-black px-10 py-4 rounded-full font-bold uppercase tracking-widest hover:bg-[#ff004c] hover:text-white transition-all transform active:scale-95 shadow-xl"
              >
                Get Started
              </button>
          ...
          <div className="w-full lg:w-1/2 flex justify-center relative">
            ...
            <div className="relative animate-float">
              <div className="w-64 h-[450px] lg:w-72 lg:h-[550px] bg-gradient-to-b from-[#ff004c] to-[#4b0000] rounded-[40px] shadow-[0_0_100px_rgba(255,0,76,0.4)] border-4 border-white/10 relative overflow-hidden group">
                <div className="absolute inset-0 bg-[url('https://www.transparenttextures.com/patterns/carbon-fibre.png')] opacity-20"></div>
                <div className="absolute top-10 w-full text-center">
                   <h3 className="font-display text-4xl font-black tracking-tighter text-white opacity-80">ALMANDINE</h3>
                   <p className="text-[10px] tracking-[0.3em] font-bold text-red-200 uppercase mt-1">Garnet Extract Edition</p>
                </div>
                <div className="absolute bottom-10 left-1/2 -translate-x-1/2 flex flex-col items-center">
                  <div className="w-12 h-12 rounded-full border-2 border-white/30 flex items-center justify-center">
                    <i className="fas fa-bolt text-white text-xl"></i>
                  </div>
                  <p className="mt-4 text-[8px] uppercase tracking-widest font-black text-white/40">500ml | 0 Sugar</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section id="benefits" className="py-24 bg-white/[0.02]">
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="glass-card p-10 rounded-3xl hover:border-[#ff004c]/30 transition-all group cursor-pointer" onClick={() => onNavigate('science')}>
              <div className="w-16 h-16 bg-gradient-to-br from-red-500 to-red-900 rounded-2xl flex items-center justify-center mb-8 shadow-lg transform group-hover:rotate-12 transition-transform">
                <i className="fas fa-gem text-2xl"></i>
              </div>
              <h3 className="text-2xl font-bold mb-4 uppercase italic">Crystalline Purity</h3>
            ...
            <div className="glass-card p-10 rounded-3xl hover:border-[#ff004c]/30 transition-all group">
              <div className="w-16 h-16 bg-gradient-to-br from-red-500 to-red-900 rounded-2xl flex items-center justify-center mb-8 shadow-lg transform group-hover:rotate-12 transition-transform">
                <i className="fas fa-microchip text-2xl"></i>
              </div>
              <h3 className="text-2xl font-bold mb-4 uppercase italic">Neural Focus</h3>
            ...
            <div className="glass-card p-10 rounded-3xl hover:border-[#ff004c]/30 transition-all group">
              ...
              <h3 className="text-2xl font-bold mb-4 uppercase italic">Bio-Optimized</h3>
      ...
      <section id="ai-spark" className="py-24 relative overflow-hidden">
        <div className="absolute right-0 top-0 w-[500px] h-[500px] bg-red-600/5 blur-[120px] rounded-full"></div>
        <div className="container mx-auto px-6">
          <div className="glass-card rounded-[40px] p-8 lg:p-20 flex flex-col lg:flex-row items-center gap-16">
            <div className="w-full lg:w-1/2">
              <h2 className="font-display text-4xl lg:text-5xl font-black mb-6 uppercase italic">Fuel Your <span className="text-[#ff004c]">Vibe</span></h2>
              ...
              <div className="bg-black/40 border border-white/5 rounded-2xl p-6 min-h-[160px] flex flex-col justify-center">
                {isGenerating ? (
                  <div className="flex items-center space-x-3 text-gray-500 italic">
                    <div className="w-4 h-4 border-2 border-[#ff004c] border-t-transparent rounded-full animate-spin"></div>
                    <span>AI is calculating your frequency...</span>
                  </div>
                ) : (
                  <>
                    <p className="text-[#ff004c] font-display text-xl font-bold mb-2 uppercase tracking-tight">"{aiContent.tagline}"</p>
            ...
            <div className="w-full lg:w-1/2 relative">
               <div className="aspect-square bg-gradient-almandine rounded-[60px] flex items-center justify-center p-12 overflow-hidden">
                  <i className="fas fa-robot text-[120px] lg:text-[180px] text-white/20 absolute -right-10 -bottom-10 transform rotate-12"></i>
                  <div className="text-center z-10">
                    <div className="w-20 h-20 bg-white/10 backdrop-blur-md rounded-full mx-auto flex items-center justify-center mb-6 border border-white/20">
                      <i className="fas fa-sparkles text-white text-3xl"></i>
                    </div>
                    <p className="text-white font-display text-2xl font-black uppercase tracking-widest leading-tight">Almandine AI<br/><span className="text-red-300">Engineered Pulse</span></p>
                  </div>
               </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {INGREDIENTS.map((ing, idx) => (
              <div key={idx} className="glass-card p-8 rounded-3xl group hover:bg-[#ff004c]/5 transition-colors cursor-pointer" onClick={() => onNavigate('science')}>
                <i className={`fas ${ing.icon} text-3xl text-[#ff004c] mb-6 group-hover:scale-110 transition-transform`}></i>
                <h3 className="text-xl font-bold mb-2 uppercase tracking-wide italic">{ing.name}</h3>
                <p className="text-[#ff004c] text-[10px] font-black uppercase tracking-[0.2em] mb-4">{ing.benefit}</p>
        ...
        <div className="container mx-auto px-6 text-center">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 text-left">
            {TESTIMONIALS.map((t, idx) => (
              <div key={idx} className="bg-black/50 border border-white/5 p-8 rounded-2xl relative group hover:border-[#ff004c]/30 transition-colors">
                <div className="flex text-[#ff004c] mb-6">
                ...
                <div className="flex items-center">
                  <div className="w-10 h-10 bg-gradient-almandine rounded-full mr-4 flex items-center justify-center font-bold">
                    {t.name[0]}
                  </div>
                  <div>
        ...
        <div className="container mx-auto px-6 text-center">
          <div className="max-w-4xl mx-auto">
            <h2 className="font-display text-5xl lg:text-8xl font-black mb-10 tracking-tighter uppercase italic leading-none">
              Stop surviving. <br/> <span className="text-gradient underline decoration-[#ff004c]/30">Start conquering.</span>
            </h2>
            ...
            <div className="mt-12 flex items-center justify-center space-x-8 text-gray-500 text-xs font-bold uppercase tracking-[0.2em]">
              <span className="flex items-center"><i className="fas fa-check-circle text-[#ff004c] mr-2"></i> Fast Shipping</span>
              <span className="flex items-center"><i className="fas fa-check-circle text-[#ff004c] mr-2"></i> Lab Tested</span>
              <span className="flex items-center"><i className="fas fa-check-circle text-[#ff004c] mr-2"></i> No Crash Guarantee</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <footer className="py-12 border-t border-white/5">
        <div className="container mx-auto px-6 flex flex-col md:flex-row justify-between items-center text-gray-600 text-xs font-bold tracking-widest uppercase">
          ...
          <div className="flex space-x-6">
            <a href="#" className="hover:text-[#ff004c] text-lg"><i className="fab fa-instagram"></i></a>
            <a href="#" className="hover:text-[#ff004c] text-lg"><i className="fab fa-twitter"></i></a>
            <a href="#" className="hover:text-[#ff004c] text-lg"><i className="fab fa-tiktok"></i></a>
          </div>
        </div>
