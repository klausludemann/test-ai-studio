  ...
  return (
    <>
        ...
        <div className="container mx-auto px-6 flex justify-between items-center">
          <div className="flex items-center cursor-pointer" onClick={() => onNavigate('home')}>
            <div className="w-8 h-8 bg-gradient-almandine rounded-bl-xl rounded-tr-xl flex items-center justify-center transform rotate-45">
              <div className="transform -rotate-45 font-display font-black text-xs text-black">B</div>
            </div>
            <span className="font-display text-2xl font-black tracking-tighter italic ml-4">B-VERVE</span>
          </div>
          ...
          <button 
            ...
            className="bg-gradient-almandine px-6 py-2 rounded-full text-xs font-bold text-black uppercase tracking-widest hover:scale-105 active:scale-95 transition-transform shadow-[0_0_20px_rgba(0,180,255,0.3)]"
          >
            Shop Now
          </button>
        </div>
      ...
      <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-40 overflow-hidden">
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[1000px] h-[1000px] bg-[#00b4ff]/10 blur-[150px] rounded-full pointer-events-none"></div>
        <div className="container mx-auto px-6 flex flex-col lg:flex-row items-center justify-between relative z-10">
          <div className="w-full lg:w-1/2 text-center lg:text-left mb-16 lg:mb-0">
            <div className="inline-block px-4 py-1 rounded-full border border-blue-900/50 bg-blue-950/20 text-[#00b4ff] text-xs font-bold uppercase tracking-widest mb-6">
            ...
            <p className="text-gray-400 text-lg lg:text-xl max-w-xl mx-auto lg:mx-0 mb-10 font-light leading-relaxed">
              Engineered for the elite. B-Verve delivers ultra-pure energy with zero sugar, zero crash, and unmatched focus.
            </p>
            <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start space-y-4 sm:space-y-0 sm:space-x-4">
              <button 
                onClick={() => onNavigate('shop')}
                className="w-full sm:w-auto bg-white text-black px-10 py-4 rounded-full font-bold uppercase tracking-widest hover:bg-[#00b4ff] hover:text-black transition-all transform active:scale-95 shadow-xl"
              >
                Get Started
              </button>
          ...
          <div className="w-full lg:w-1/2 flex justify-center relative">
            ...
            <div className="relative animate-float">
              <div className="w-64 h-[450px] lg:w-72 lg:h-[550px] bg-gradient-to-b from-[#00b4ff] to-[#003366] rounded-[40px] shadow-[0_0_100px_rgba(0,180,255,0.4)] border-4 border-white/10 relative overflow-hidden group">
                <div className="absolute inset-0 bg-[url('https://www.transparenttextures.com/patterns/carbon-fibre.png')] opacity-20"></div>
                <div className="absolute top-10 w-full text-center">
                   <h3 className="font-display text-4xl font-black tracking-tighter text-black opacity-80">B-VERVE</h3>
                   <p className="text-[10px] tracking-[0.3em] font-bold text-blue-900 uppercase mt-1">Neon Pulse Edition</p>
                </div>
      ...
      <section id="benefits" className="py-24 bg-white/[0.02]">
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="glass-card p-10 rounded-3xl hover:border-[#00b4ff]/30 transition-all group cursor-pointer" onClick={() => onNavigate('science')}>
              <div className="w-16 h-16 bg-gradient-to-br from-blue-400 to-blue-900 rounded-2xl flex items-center justify-center mb-8 shadow-lg transform group-hover:rotate-12 transition-transform">
                <i className="fas fa-gem text-2xl text-black"></i>
              </div>
              <h3 className="text-2xl font-bold mb-4 uppercase italic text-[#00b4ff]">Crystalline Purity</h3>
            ...
            <div className="glass-card p-10 rounded-3xl hover:border-[#00b4ff]/30 transition-all group">
              <div className="w-16 h-16 bg-gradient-to-br from-blue-400 to-blue-900 rounded-2xl flex items-center justify-center mb-8 shadow-lg transform group-hover:rotate-12 transition-transform">
                <i className="fas fa-microchip text-2xl text-black"></i>
              </div>
              <h3 className="text-2xl font-bold mb-4 uppercase italic text-[#00b4ff]">Neural Focus</h3>
            ...
            <div className="glass-card p-10 rounded-3xl hover:border-[#00b4ff]/30 transition-all group">
              ...
              <h3 className="text-2xl font-bold mb-4 uppercase italic text-[#00b4ff]">Bio-Optimized</h3>
      ...
      <section id="ai-spark" className="py-24 relative overflow-hidden">
        <div className="absolute right-0 top-0 w-[500px] h-[500px] bg-blue-600/5 blur-[120px] rounded-full"></div>
        <div className="container mx-auto px-6">
          <div className="glass-card rounded-[40px] p-8 lg:p-20 flex flex-col lg:flex-row items-center gap-16">
            <div className="w-full lg:w-1/2">
              <h2 className="font-display text-4xl lg:text-5xl font-black mb-6 uppercase italic">Fuel Your <span className="text-[#00b4ff]">Vibe</span></h2>
              <p className="text-gray-400 mb-8 text-lg">Tell us what you're doing, and let B-Verve AI generate your personalized performance mantra.</p>
              ...
              <div className="bg-black/40 border border-white/5 rounded-2xl p-6 min-h-[160px] flex flex-col justify-center">
                {isGenerating ? (
                  <div className="flex items-center space-x-3 text-gray-500 italic">
                    <div className="w-4 h-4 border-2 border-[#00b4ff] border-t-transparent rounded-full animate-spin"></div>
                    <span>AI is calculating your frequency...</span>
                  </div>
                ) : (
                  <>
                    <p className="text-[#00b4ff] font-display text-xl font-bold mb-2 uppercase tracking-tight">"{aiContent.tagline}"</p>
               ...
               <div className="aspect-square bg-gradient-almandine rounded-[60px] flex items-center justify-center p-12 overflow-hidden">
                  ...
                  <div className="text-center z-10">
                    <div className="w-20 h-20 bg-black/10 backdrop-blur-md rounded-full mx-auto flex items-center justify-center mb-6 border border-white/20">
                      <i className="fas fa-sparkles text-[#00b4ff] text-3xl"></i>
                    </div>
                    <p className="text-black font-display text-2xl font-black uppercase tracking-widest leading-tight">B-Verve AI<br/><span className="text-blue-900">Engineered Pulse</span></p>
                  </div>
               </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-6">
          <div className="flex flex-col lg:flex-row justify-between items-end mb-16 gap-6">
            ...
            <div className="max-w-md text-gray-500 text-sm italic">
              We don't hide behind proprietary blends. Every milligram of B-Verve is calculated for maximum physiological response and cognitive clarity.
            </div>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {INGREDIENTS.map((ing, idx) => (
              <div key={idx} className="glass-card p-8 rounded-3xl group hover:bg-[#00b4ff]/5 transition-colors cursor-pointer" onClick={() => onNavigate('science')}>
                <i className={`fas ${ing.icon} text-3xl text-[#00b4ff] mb-6 group-hover:scale-110 transition-transform`}></i>
                <h3 className="text-xl font-bold mb-2 uppercase tracking-wide italic">{ing.name}</h3>
                <p className="text-[#00b4ff] text-[10px] font-black uppercase tracking-[0.2em] mb-4">{ing.benefit}</p>
        ...
        <div className="container mx-auto px-6 text-center">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 text-left">
            {TESTIMONIALS.map((t, idx) => (
              <div key={idx} className="bg-black/50 border border-white/5 p-8 rounded-2xl relative group hover:border-[#00b4ff]/30 transition-colors">
                <div className="flex text-[#00b4ff] mb-6">
        ...
        <div className="container mx-auto px-6 text-center">
          <div className="max-w-4xl mx-auto">
            <h2 className="font-display text-5xl lg:text-8xl font-black mb-10 tracking-tighter uppercase italic leading-none">
              Stop surviving. <br/> <span className="text-gradient underline decoration-[#00b4ff]/30">Start conquering.</span>
            </h2>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-6">
              <button 
                onClick={() => onNavigate('shop')}
                className="bg-white text-black px-12 py-5 rounded-full font-black uppercase tracking-widest text-lg hover:bg-[#00b4ff] hover:text-black transition-all shadow-2xl"
              >
                Order B-Verve Now
              </button>
            </div>
            <div className="mt-12 flex items-center justify-center space-x-8 text-gray-500 text-xs font-bold uppercase tracking-[0.2em]">
              <span className="flex items-center"><i className="fas fa-check-circle text-[#00b4ff] mr-2"></i> Fast Shipping</span>
              <span className="flex items-center"><i className="fas fa-check-circle text-[#00b4ff] mr-2"></i> Lab Tested</span>
              <span className="flex items-center"><i className="fas fa-check-circle text-[#00b4ff] mr-2"></i> No Crash Guarantee</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <footer className="py-12 border-t border-white/5">
        <div className="container mx-auto px-6 flex flex-col md:flex-row justify-between items-center text-gray-600 text-xs font-bold tracking-widest uppercase">
          <div className="flex items-center space-x-2 mb-6 md:mb-0 cursor-pointer" onClick={() => onNavigate('home')}>
             <span className="font-display text-lg font-black tracking-tighter text-white">B-VERVE</span>
          </div>
          ...
          <div className="flex space-x-6">
            <a href="#" className="hover:text-[#00b4ff] text-lg"><i className="fab fa-instagram"></i></a>
            <a href="#" className="hover:text-[#00b4ff] text-lg"><i className="fab fa-twitter"></i></a>
            <a href="#" className="hover:text-[#00b4ff] text-lg"><i className="fab fa-tiktok"></i></a>
          </div>
        </div>
        <div className="text-center mt-10 text-[10px] text-gray-800 uppercase tracking-widest">
          © {new Date().getFullYear()} B-Verve Energy. All rights reserved. Spark the Voltage.
        </div>
      </footer>
    </>
  );
