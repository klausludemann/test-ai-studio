...
const SciencePage: React.FC<SciencePageProps> = ({ onNavigate }) => {
  ...
  return (
    <div className="pb-20">
      ...
      {/* Hero Header */}
      <section className="pt-32 pb-16 border-b border-white/5 bg-[radial-gradient(circle_at_50%_50%,_rgba(57,255,20,0.05)_0%,_transparent_100%)]">
        <div className="container mx-auto px-6 text-center">
          <p className="text-[#39ff14] text-xs font-black uppercase tracking-[0.4em] mb-4">Laboratory Report v3.1</p>
        ...
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="order-2 lg:order-1">
              <div className="w-20 h-2 bg-[#39ff14] mb-10"></div>
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  <div className="w-10 h-10 border border-[#39ff14]/30 rounded flex items-center justify-center mr-6 flex-shrink-0">
                    <span className="text-[#39ff14] font-black text-xs">01</span>
                  </div>
                  <div>
                    <h4 className="font-bold uppercase tracking-wide mb-1 text-[#39ff14]">Crystalline Stabilization</h4>
                    <p className="text-gray-500 text-sm italic">Harmonizing the molecular clusters of H2O for rapid gastric emptying.</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <div className="w-10 h-10 border border-[#39ff14]/30 rounded flex items-center justify-center mr-6 flex-shrink-0">
                    <span className="text-[#39ff14] font-black text-xs">02</span>
                  </div>
                  <div>
                    <h4 className="font-bold uppercase tracking-wide mb-1 text-[#39ff14]">Kinetic Enrichment</h4>
            ...
            <div className="order-1 lg:order-2">
              <div className="aspect-video bg-black rounded-3xl border border-white/10 relative overflow-hidden flex items-center justify-center group">
                 <div className="absolute inset-0 bg-gradient-to-br from-[#39ff14]/20 to-transparent opacity-50 group-hover:opacity-100 transition-opacity"></div>
                 <div className="z-10 text-center">
                    <div className="w-32 h-32 border-2 border-[#39ff14] rounded-full mx-auto flex items-center justify-center relative animate-pulse">
                      <i className="fas fa-bolt text-5xl text-[#39ff14]"></i>
                      <div className="absolute inset-0 border-4 border-white/5 rounded-full scale-125"></div>
                    </div>
                    <p className="mt-8 text-[10px] uppercase tracking-[0.4em] font-black text-[#39ff14]/40">Molecular Visualization v2.0</p>
                 </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-24 bg-white/[0.02] border-y border-white/5">
        <div className="container mx-auto px-6">
          <h2 className="font-display text-4xl font-black uppercase tracking-tighter text-center mb-20 italic">Compound <span className="text-[#39ff14]">Analysis</span></h2>
          
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            {/* Caffeine + L-Theanine */}
            <div className="bg-black/40 p-10 rounded-[30px] border border-white/5 hover:border-[#39ff14]/20 transition-all">
              <div className="flex items-center mb-8">
                 <div className="p-4 bg-green-950/20 rounded-2xl mr-6">
                    <i className="fas fa-brain text-2xl text-[#39ff14]"></i>
                 </div>
              ...
              <ul className="space-y-4 text-sm text-gray-500">
                <li className="flex items-center"><i className="fas fa-check text-[#39ff14] mr-3"></i> Alpha Wave Production Increase</li>
                <li className="flex items-center"><i className="fas fa-check text-[#39ff14] mr-3"></i> Peripheral Vasodilation Enhancement</li>
                <li className="flex items-center"><i className="fas fa-check text-[#39ff14] mr-3"></i> Zero Nervous Jitters</li>
              </ul>
            </div>
            ...
            <div className="bg-black/40 p-10 rounded-[30px] border border-white/5 hover:border-[#39ff14]/20 transition-all">
              <div className="flex items-center mb-8">
                 <div className="p-4 bg-green-950/20 rounded-2xl mr-6">
                    <i className="fas fa-bolt text-2xl text-[#39ff14]"></i>
                 </div>
              ...
              <ul className="space-y-4 text-sm text-gray-500">
                <li className="flex items-center"><i className="fas fa-check text-[#39ff14] mr-3"></i> Mitochondria Efficiency Optimization</li>
                <li className="flex items-center"><i className="fas fa-check text-[#39ff14] mr-3"></i> Increased V02 Max Utility</li>
                <li className="flex items-center"><i className="fas fa-check text-[#39ff14] mr-3"></i> Sustained Energy via Natural Bloodflow</li>
              </ul>
            </div>
          </div>
        </div>
      ...
      <section className="py-24">
        <div className="container mx-auto px-6 text-center">
          ...
          <div className="max-w-5xl mx-auto glass-card p-12 rounded-[40px] border border-[#39ff14]/10">
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
              <div>
                <div className="text-5xl font-black text-[#39ff14] mb-2">94%</div>
              ...
              <div>
                <div className="text-5xl font-black text-[#39ff14] mb-2">7hrs</div>
