      ...
      <nav className="fixed top-0 w-full z-50 bg-[#050505]/95 backdrop-blur-md py-4 border-b border-white/10">
        <div className="container mx-auto px-6 flex justify-between items-center">
          <div className="flex items-center">
             <i className="fas fa-tools text-[#00b4ff] mr-4"></i>
      ...
      <div className="container mx-auto px-6 pt-32 max-w-4xl">
        <div className="mb-12 flex justify-between items-end">
          <div>
            ...
            <p className="text-gray-500 text-sm italic">Manage B-Verve product pricing, visuals, and marketing claims in real-time.</p>
          </div>
        ...
        {saveStatus && (
          <div className="mb-8 p-4 bg-blue-900/20 border border-blue-500/50 rounded-xl text-blue-400 text-xs font-bold text-center">
            {saveStatus}
          </div>
        )}
            ...
            <div key={p.id} className="glass-card p-8 rounded-3xl border border-white/5 hover:border-white/10 transition-colors">
                ...
                <div className="space-y-6">
                  <div>
                    ...
                    <input 
                      ...
                      className="w-full bg-black/50 border border-white/10 rounded-xl px-4 py-3 text-sm focus:border-[#00b4ff] outline-none transition-colors"
                    />
                  </div>
                  <div>
                    ...
                    <input 
                      ...
                      className="w-full bg-black/50 border border-white/10 rounded-xl px-4 py-3 text-sm focus:border-[#00b4ff] outline-none transition-colors font-display"
                    />
                  </div>
                  <div>
                    ...
                    <input 
                      ...
                      className="w-full bg-black/50 border border-white/10 rounded-xl px-4 py-3 text-sm focus:border-[#00b4ff] outline-none transition-colors italic"
                    />
                  </div>
                </div>
                <div className="space-y-6">
                  <div>
                    ...
                    <input 
                      ...
                      className="w-full bg-black/50 border border-white/10 rounded-xl px-4 py-3 text-[10px] focus:border-[#00b4ff] outline-none transition-colors"
                    />
                  </div>
                  <div className="relative">
                    ...
                    <div className="aspect-video bg-black rounded-xl border border-white/10 overflow-hidden">
                      ...
                      <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                         <span className="text-[10px] font-black uppercase text-[#00b4ff]/20 tracking-[0.5em]">Live Render</span>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="mt-8 pt-6 border-t border-white/5">
                ...
                <textarea 
                  ...
                  className="w-full bg-black/50 border border-white/10 rounded-xl px-4 py-3 text-xs focus:border-[#00b4ff] outline-none transition-colors h-24 resize-none"
                />
              </div>
            </div>
          ))}
